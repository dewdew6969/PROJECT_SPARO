...
const translations = {
  'English (US)': {
    ...
    tournament_completed_success: 'Tournament Status Updated',
    tournament_completed_msg: 'The tournament "{title}" has been successfully concluded.',
    notification: 'Notification',
    already_registered: 'You have already registered for this tournament.',
    tournament_full: 'Sorry, the participant quota for this tournament is full.',
    registration_success: 'Registration Successful',
    registered_tournament_prefix: 'You have successfully registered for the tournament',
    registered_tournament_suffix: 'The full match schedule and further information will be emailed to you shortly.',
    delete_failed_title: 'Delete Failed',
    delete_failed_message: 'Failed to delete tournament. It might have already been deleted or a network error occurred.',
  ...
  'Bahasa Indonesia': {
    ...
    tournament_completed_success: 'Status Turnamen Diperbarui',
    tournament_completed_msg: 'Turnamen "{title}" berhasil diselesaikan.',
    notification: 'Pemberitahuan',
    already_registered: 'Anda telah terdaftar dalam turnamen ini.',
    tournament_full: 'Maaf, kuota peserta untuk turnamen ini telah terpenuhi.',
    registration_success: 'Pendaftaran Berhasil',
    registered_tournament_prefix: 'Anda telah resmi terdaftar dalam turnamen',
    registered_tournament_suffix: 'Jadwal lengkap pertandingan beserta informasi lanjutan akan segera dikirimkan ke email Anda.',
    delete_failed_title: 'Gagal Menghapus',
    delete_failed_message: 'Turnamen gagal dihapus. Mungkin data sudah terhapus sebelumnya atau terjadi gangguan jaringan.',
